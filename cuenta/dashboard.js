                 ...
                 productsHTML += `
                     <div class="product-card">
                         <div class="product-image" style="${product.image_url ? `background-image: url(${product.image_url}); background-size:cover;` : ''}">
                             ...
                             <span class="product-badge">${product.product_type || 'Preset'}</span> {/* Asume product_type */}
                         </div>
                         <div class="product-info">
                             <div class="product-title">${product.name}</div>
                             <div class="product-meta">
                                 {/* Podríamos añadir status (pending/approved) aquí */}
                             </div>
                             <div class="product-price">$${product.price}</div>
                             <div class="product-stats">
                                 {/* TODO: Cargar stats reales del producto */}
                                 <div><i class="fas fa-shopping-bag"></i> --</div>
                                 <div><i class="fas fa-eye"></i> --</div>
                             </div>
                             {/* TODO: Añadir botones Editar/Eliminar aquí */}
                         </div>
                     </div>
                 `;
             });
